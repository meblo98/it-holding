                            ...
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <input type="text" name="title" id="title" class="mt-1 focus:ring-gold-500 focus:border-gold-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3" value="{{ old('title', $service->title) }}" required>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <input type="text" name="description" id="description" class="mt-1 focus:ring-gold-500 focus:border-gold-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3" value="{{ old('description', $service->description) }}" required>
                                    </div>
                                    
                                    <div class="col-span-6">
                                        <label for="content" class="block text-sm font-medium text-gray-700">Contenu détaillé <span class="text-red-500">*</span></label>
                                        <div class="mt-1">
                                            <textarea id="content" name="content" rows="5" class="shadow-sm focus:ring-gold-500 focus:border-gold-500 block w-full sm:text-sm border border-gray-300 rounded-md p-3" required>{{ old('content', $service->content) }}</textarea>
                                        </div>
                                    </div>

                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="icon" class="block text-sm font-medium text-gray-700">Classe d'icône (FontAwesome/Heroicons)</label>
                                        <input type="text" name="icon" id="icon" class="mt-1 focus:ring-gold-500 focus:border-gold-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3" value="{{ old('icon', $service->icon) }}">
                                    </div>
