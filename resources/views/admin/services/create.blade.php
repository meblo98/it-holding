                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input type="text" name="title" id="title" 
                                    ...
                                    placeholder="Ex: Développement Web" value="{{ old('title') }}" required>
                                @error('title')
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="number" name="price" id="price" min="0" step="0.01" 
                                    ...
                                    placeholder="Ex: 50000" value="{{ old('price') }}">
                                @error('price')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select name="icon" id="icon" 
                                    ...
                                    <option value="code" {{ old('icon') == 'code' ? 'selected' : '' }}>Code / Développement (code)</option>
                                    <option value="cloud" {{ old('icon') == 'cloud' ? 'selected' : '' }}>Cloud (cloud)</option>
                                    <option value="shield-check" {{ old('icon') == 'shield-check' ? 'selected' : '' }}>Sécurité (shield-check)</option>
                                    <option value="database" {{ old('icon') == 'database' ? 'selected' : '' }}>Base de données (database)</option>
                                    <option value="refresh" {{ old('icon') == 'refresh' ? 'selected' : '' }}>Maintenance (refresh)</option>
                                    <option value="support" {{ old('icon') == 'support' ? 'selected' : '' }}>Support client (support)</option>
                                </select>
                                @error('icon')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" name="description" id="description" 
                                    ...
                                    placeholder="Brève description pour la liste des services." value="{{ old('description') }}" required>
                                @error('description')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-1">
                                    <textarea id="content" name="content" rows="6" 
                                        ...
                                        placeholder="Description complète du service." required>{{ old('content') }}</textarea>
                                </div>
                                @error('content')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
