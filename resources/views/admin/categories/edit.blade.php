                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                @if ($category->children->count())
                                    <p class="mt-1 text-xs text-yellow-600">Cette catégorie a des sous-catégories — elle ne peut pas devenir une sous-catégorie.</p>
                                @else
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="mt-1 shadow-sm focus:ring-gold-500 focus:border-gold-500 block w-full sm:text-sm border border-gray-300 rounded-md">{{ old('description', $category->description) }}</textarea>
                            </div>
