        ...
        <div class="flex justify-end mb-10">
            <div class="w-64">
                ...
                <div class="flex justify-between py-2 border-b text-sm">
                    ...
                    <span class="font-bold text-gray-900">{{ number_format($quote->subtotal, 0, ',', ' ') }} FCFA</span>
                </div>
                <div class="flex justify-between py-2 border-b text-sm">
                    <span class="text-gray-600">TVA (18%)</span>
                    <span class="font-bold text-gray-900">{{ number_format($quote->tax_amount, 0, ',', ' ') }} FCFA</span>
                </div>
