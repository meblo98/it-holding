...
@section('title', 'Nouvelle Marque - Admin')

@section('content')
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Ajouter une Marque</h3>
                <p class="mt-1 text-sm text-gray-600">
                    Créez une nouvelle marque de produits.
                </p>
            </div>
        </div>
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-1">
                                    <textarea id="description" name="description" rows="4"
                                        class="shadow-sm focus:ring-gold-500 focus:border-gold-500 block w-full sm:text-sm border border-gray-300 rounded-md">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
