...
<div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <div class="flex flex-wrap gap-2">
        ...
        <form action="{{ route('admin.invoices.destroy', $invoice->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette facture ?')" class="inline">
            @csrf
            @method('DELETE')
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tfoot class="bg-gray-50">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-2 text-right text-sm font-bold text-gray-900">{{ number_format($invoice->subtotal, 0, ',', ' ') }} FCFA</td>
                    </tr>
                    <tr>
                        <td colspan="3" class="px-6 py-2 text-right text-sm font-medium text-gray-500 uppercase">TVA (18%)</td>
                        <td class="px-6 py-2 text-right text-sm font-bold text-gray-900">{{ number_format($invoice->tax_amount, 0, ',', ' ') }} FCFA</td>
                    </tr>
                    <tr>
                        <td colspan="3" class="px-6 py-3 text-right text-sm font-bold text-gray-700 uppercase">Total TTC</td>
                        <td class="px-6 py-3 text-right text-xl font-extrabold text-navy-600">{{ number_format($invoice->total_amount, 0, ',', ' ') }} FCFA</td>
                    </tr>
                    @else
                    <tr>
