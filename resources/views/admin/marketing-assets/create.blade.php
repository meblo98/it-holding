...
@section('title', 'Ajouter une Ressource Marketing - Admin')

@section('content')
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Ajouter une Ressource</h3>
                <p class="mt-1 text-sm text-gray-600">
                    Importez une nouvelle ressource (Flyer, Image, Document) pour vos partenaires.
                </p>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <select name="category" id="category"
                                    ...
                                    <option value="image" {{ old('category') == 'image' ? 'selected' : '' }}>🖼️ Image / Photo Produit</option>
                                    <option value="pdf" {{ old('category') == 'pdf' ? 'selected' : '' }}>📄 Document PDF / Flyer</option>
                                    <option value="document" {{ old('category') == 'document' ? 'selected' : '' }}>📝 Texte de vente / Argumentaire</option>
                                    <option value="template" {{ old('category') == 'template' ? 'selected' : '' }}>🎨 Gabarit Canva / Modèle</option>
                            ...
                            <div class="col-span-6">
                                <label for="file" class="block text-sm font-medium text-gray-700">Fichier à téléverser *</label>
