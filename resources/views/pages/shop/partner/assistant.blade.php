        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <main class="flex-1 space-y-8">
                ...
                <div class="flex flex-wrap border-b border-gray-200 bg-white rounded-xl p-2 shadow-sm gap-2">
                    ...
                    <a href="{{ route('dashboard.partner.assistant') }}" class="px-4 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-colors bg-navy-900 text-white flex items-center gap-2">
