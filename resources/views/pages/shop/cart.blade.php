        ...
        <div class="max-w-7xl mx-auto pt-12 pb-24 px-4 sm:px-6 lg:px-8">
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:items-start">
                <section aria-labelledby="cart-heading" class="lg:col-span-7">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                        @forelse($cart as $id => $details)
                            <div class="flex py-6 px-6 border-b border-gray-200 hover:bg-gray-50 transition-colors duration-200"
                                data-product-id="{{ $id }}">
                                <div class="flex-shrink-0">
                                    @if (isset($details['image']) && $details['image'])
                                        <img src="{{ asset('storage/' . $details['image']) }}" alt="{{ $details['name'] }}"
                                            class="w-24 h-24 rounded-lg object-center object-cover shadow-md">
                                    @else
                                        <div
                                            class="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center text-gray-400 shadow-md">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <button type="button" onclick="updateQuantity({{ $id }}, -1)"
                                                class="inline-flex items-center justify-center w-8 h-8 border-2 border-gray-300 rounded-lg text-gray-600 hover:border-indigo-500 hover:text-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors duration-200">
                ...
                <section aria-labelledby="summary-heading"
                    class="mt-8 bg-white rounded-2xl shadow-lg px-6 py-8 lg:mt-0 lg:col-span-5 sticky top-8">
                    ...
                    <dl class="space-y-4">
                        ...
                        <div class="border-t border-gray-200 pt-4 flex items-center justify-between">
                            ...
                            <dd id="total" class="text-2xl font-bold text-indigo-600">
                                {{ number_format($total, 0, ',', ' ') }} FCFA</dd>
                        </div>
                    </dl>
