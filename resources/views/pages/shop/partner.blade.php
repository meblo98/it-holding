                ...
                <div class="bg-navy-900 text-white rounded-2xl p-8 relative overflow-hidden shadow-lg border-b-4 border-gold-500">
                    ...
                    <div class="relative z-10 space-y-4">
                        ...
                        <p class="text-xs text-gray-300 max-w-xl font-medium leading-relaxed italic">
                            Partagez votre code promo unique avec votre audience, vos amis ou vos clients. Pour chaque achat effectué avec votre code : vos contacts bénéficient de <b>5% de réduction immédiate</b>, et vous recevez une commission de <b>10% du montant de leur commande</b> directement versée sur votre portefeuille.
                        </p>
                    </div>
                </div>
