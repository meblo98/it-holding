        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                @forelse($products as $product)
                    <div
                        class="group card-hover bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-200 overflow-hidden relative">
                        <!-- Badge Nouveau -->
                        ...
                        <div class="p-4">
                            ...
                            @if ($product->stock > 0)
                                <div class="mt-4 flex items-center justify-between">
                                    <span class="inline-block text-xs font-semibold text-green-600">En stock</span>
                            ...
                            @else
                                <span class="inline-block mt-2 text-xs font-semibold text-red-600">Rupture de stock</span>
                            @endif
                        </div>
                    </div>
                @empty
