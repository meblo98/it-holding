            ...
            <div x-data="{ 
                ...
                <form action="{{ route('shop.addToCart', $product->id) }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <a href="{{ route('dashboard.savings.create', ['product_id' => $product->id]) }}" class="w-full border-2 border-gold-500 text-gold-600 hover:bg-gold-500 hover:text-navy-900 h-12 uppercase tracking-widest text-xs font-black transition-all rounded-lg flex items-center justify-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            Commencer une Épargne Produit
                        </a>
                        @else
                        ...
                        <a href="{{ route('login') }}" class="w-full border-2 border-dashed border-gold-300 text-gold-500 hover:border-gold-500 hover:text-gold-600 h-12 uppercase tracking-widest text-xs font-bold transition-all rounded-lg flex items-center justify-center gap-2">
                            Se connecter pour commencer une épargne
                        </a>
                        @endauth
                    </div>
                </form>
