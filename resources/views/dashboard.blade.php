        ...
        <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <nav class="flex flex-col">
                        @php
                            $navItems = [
                                ...
                                ['name' => 'Espace Partenaire', 'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>', 'route' => 'dashboard.partner'],
            ...
            <main class="flex-1 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="bg-[#FFFCEB] rounded-lg p-6 flex items-center gap-6 border border-[#FFF3C5]">
                        <div class="w-14 h-14 bg-white rounded flex items-center justify-center text-gold-500 shadow-inner">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                        </div>
                        <div>
                            <span class="text-2xl font-black text-navy-900 block tracking-tighter">{{ str_pad($activeWarrantiesCount ?? 0, 2, '0', STR_PAD_LEFT) }}</span>
                            <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest italic">Garanties Actives</span>
                        </div>
                    </div>
                </div>
