    ...
    <section class="bg-gradient-to-br from-gold-400 via-gold-500 to-navy-500 relative overflow-hidden">
        <div class="max-w-7xl mx-auto py-20 px-4 sm:py-28 sm:px-6 lg:px-8">
            <div class="relative z-10">
                <!-- Promo Badge -->
                <div class="inline-flex items-center bg-navy-700 text-white px-6 py-2 rounded-full text-sm font-bold uppercase mb-6">
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="{{ route('services.index') }}" class="inline-flex items-center px-8 py-4 border-2 border-navy-800 text-base font-bold rounded-lg text-navy-900 bg-white hover:bg-navy-50 transition-all duration-200 shadow-xl hover:shadow-2xl">
                        Nos Services
                    </a>
                    <a href="{{ route('contact.index') }}" class="inline-flex items-center px-8 py-4 border-2 border-white text-base font-bold rounded-lg text-white bg-navy-700 hover:bg-navy-800 transition-all duration-200">
                        Contactez-nous
                    </a>
                </div>
            </div>
    ...
    <section class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-4 text-lg text-gray-600">Découvrez comment nous pouvons vous aider à propulser votre entreprise.</p>
            </div>
            
            <div class="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <!-- Service 1 -->
                <div class="bg-white border-2 border-gray-100 hover:border-gold-400 overflow-hidden rounded-xl transition-all duration-200 hover:shadow-lg">
                    <div class="px-6 py-8">
                ...
                <div class="bg-white border-2 border-gray-100 hover:border-gold-400 overflow-hidden rounded-xl transition-all duration-200 hover:shadow-lg">
                    <div class="px-6 py-8">
                        ...
                        <p class="mt-3 text-sm text-gray-600">Sécurisez vos locaux avec nos solutions de contrôle d'accès.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 text-center">
                <a href="{{ route('shop.index') }}" class="inline-flex items-center px-8 py-4 border-2 border-navy-700 text-base font-bold rounded-lg text-navy-900 bg-white hover:bg-navy-50 transition-all duration-200 shadow-lg hover:shadow-xl">
